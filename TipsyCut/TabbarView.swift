    ...
    var body: some View {
        ZStack(alignment: .bottom) {
            ...
            Group {
                ...
                case .diet:
                    NavigationStack { FoodMainView() } // NavigationStack 감싸기 완료
                case .home:
        ...
        .edgesIgnoringSafeArea(.bottom) // 탭 바가 화면 최하단까지 꽉 차게 설정
    }
        ...
        VStack {
            Button(action: {
                ...
                Image(systemName: "house.fill")
                    ...
                    // 홈 탭이 선택되어 있다면 메인 민트색, 아니면 어두운 회색으로 강조
...
struct TabBarButton: View {
    ...
    var body: some View {
        Button(action: {
            ...
            // 선택 유무에 따른 색상 분기 (선택 시 mintColor, 미선택 시 subColor)
